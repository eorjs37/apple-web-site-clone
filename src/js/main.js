(() => {
  ...
  const sceneInfo = [
    ...
    },
    {
      ...
      objs: {
        ...
        imagesPath: ["./src/assets/img/blend-image-1.jpg", "./src/assets/img/blend-image-2.jpg"],
        images: [],
      },
    },
  ];
  ...
  function setCanvasImages() {
    ...
    for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
      imgElem2 = new Image();
      imgElem2.src = `./src/videos/002/IMG_${7027 + i}.JPG`;
  ...
  function setLayout() {
    ...
    for (let sceneIndex = 0; sceneIndex < sceneInfo.length; sceneIndex++) {
      if (sceneInfo[sceneIndex].type === "sticky") {
        sceneInfo[sceneIndex].scrollHeight = sceneInfo[sceneIndex].heightNum * window.innerHeight;
      } else if (sceneInfo[sceneIndex].type === "normal") {
        sceneInfo[sceneIndex].scrollHeight = sceneInfo[sceneIndex].objs.container.offsetHeight;
      }
